...
set(PLATFORM_SOURCES
    ${CMAKE_CURRENT_LIST_DIR}/../kw47_mcxw72x_nbu/lcl_hadm_measurement.c
    ${CMAKE_CURRENT_LIST_DIR}/../kw47_mcxw72x_nbu/lcl_hadm_utils.c
    ${CMAKE_CURRENT_LIST_DIR}/../kw47_mcxw72x_nbu/lcl_xcvr_hal.c
)

# Platform-specific include paths for this platform
set(PLATFORM_INCLUDES
    ${CMAKE_CURRENT_LIST_DIR}/../kw47_mcxw72x_nbu
    ...
    ${SDK_DIR}/devices_int/Wireless/KW/KW43B43ZC7_NBU
    ${SDK_DIR}/devices_int/Wireless/KW/KW43B43ZC7_NBU/drivers
    ${SDK_DIR}/devices_int/Wireless/KW/periph8
    ...
    ${SDK_DIR}/middleware/wireless/XCVR/drv/nb2p4ghz/configs/gen47_5
)

# Platform-specific configuration for kw47_mcxw72x_nbu
set(PLATFORM_DEFINES
    CPU_KW43B43ZC7MFPA_NBU
)
