...
#define HADM_RXTX_FINE_LATENCY_2MBPS_HNS     (-3444)
...
#define HADM_1ST_BIT_TO_AA_MATCH_DURATION_US(phy)  (((phy) == HADM_RTT_PHY_1MBPS) ? HADM_1ST_BIT_TO_AA_MATCH_DURATION_1MBPS_US:HADM_1ST_BIT_TO_AA_MATCH_DURATION_2MBPS_US)
