        ...
        *res_buff_p++ = step_config_p->channel; /* Step_Channel */
        ...
        switch (step_config_p->mode)
        {
            case HADM_STEP_MODE0:
            {
                ...
                *res_buff_p++ = HADM_SET_RTT_AA_QUALITY(rtt_data.rtt_vld, false); /* Packet_AA_Quality */
            ...
            case HADM_STEP_MODE3:
            {
                ...
                *res_buff_p++ = (HADM_SET_RTT_AA_QUALITY(rtt_data.rtt_vld, missed_pkt)); /* Packet_AA_Quality (1 byte) */
